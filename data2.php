...
if (!empty($_GET['message']) && $_GET['message'] == 'success') {
	echo '<h3>Data Suskes Di Update</h3>';
} else if (!empty($_GET['message']) && $_GET['message'] == 'delete') {
	echo '<h3>Data Telah Dihapus!</h3>';
}
?>
<html>
<head>
...
<li><a class="nav" href="edit.php">Edit data</a></li>
</ul></li>
</ul>
	</div>	
</div>
...
<th colspan="11" align="center" style='color:white;'>DATA YANG TERDAFTAR</th>
<tr>
